...
export class SistemaAgiotaService {
    ...
    updateAgiota(agiota: Agiota): Observable<Agiota> {
        return this.http.put<Agiota>(
            `${this.apiUrl}/agiota/${agiota.id}`,
            agiota,
        );
    }
    ...
    updateCliente(cliente: Cliente): Observable<Cliente> {
        return this.http.put<Cliente>(
            `${this.apiUrl}/cliente/${cliente.id}`,
            cliente,
        );
    }
    ...
    updateEmprestimo(emprestimo: Emprestimo): Observable<Emprestimo> {
        return this.http.put<Emprestimo>(
            `${this.apiUrl}/emprestimo/${emprestimo.id}`,
            emprestimo,
        );
    }
    ...
    getEmprestimosByAgiota(idAgiota: number): Observable<Emprestimo[]> {
        return this.http.get<Emprestimo[]>(
            `${this.apiUrl}/emprestimo/agiota/${idAgiota}`,
        );
    }

    getEmprestimosByCliente(idCliente: number): Observable<Emprestimo[]> {
        return this.http.get<Emprestimo[]>(
            `${this.apiUrl}/emprestimo/cliente/${idCliente}`,
        );
    }
}
